...
class MLP_BL(nn.Module):
    """
    Class for the MLP baseline, i.e. use only an action module to predict actions given the concatenation of states (no
    passing features or feudal architecture).
    """
    ...
    def get_model_num_params(self):
        """
        Return sum of the number of parameters of trainable functions of the MLP model.
        """
        num_pars = 0
    ...
    def get_model_funcs(self):
        """
        Return list of trainable functions of the MLP model.
        """
        functions = [self._mu]
